...
/** Second insights card — full article */
export const DETAIL_SLUG_DATA_OVERLOAD =
  "moving-from-data-overload-to-actionable-insights";

/** Third insights card — full article */
export const DETAIL_SLUG_MILLION_RECORD =
  "million-record-reality-how-to-keep-review-fast-and-defensible";

/** Fourth insights card — full article */
export const DETAIL_SLUG_GENAI_ETHICS =
  "the-ethical-reality-of-genai-in-legal-practice";

/** Fifth insights card — full article */
export const DETAIL_SLUG_BOLDER_2026 = "a-bigger-bolder-2026-is-underway";
...
export const DETAIL_SLUG_ABA_AI_TURNING_POINT =
  "from-debate-to-doctrine-the-abas-ai-turning-point";

/** Eighth insights card — full article */
export const DETAIL_SLUG_DATA_TREE_HOLIDAY =
  "rockin-around-the-data-tree-a-holiday-moment-in-ediscovery";

/** Ninth insights card — full article */
export const DETAIL_SLUG_LIFE_PRESERVERS =
  "shining-a-light-on-hope-how-the-life-preservers-project-champions-survivors-through-community-advocacy-heart";

/** Tenth through fifteenth — full articles */
export const DETAIL_SLUG_EDISCOVERY_SIMPLE =
  "ediscovery-made-simple-celebrate-the-future-of-legal-technology";

export const DETAIL_SLUG_MASTERS_ATLANTA_RECAP =
  "from-data-dumps-to-a-ha-moments-kevin-leads-a-standout-session-at-masters-conference-atlanta";

export const DETAIL_SLUG_BEFORE_REVIEW_BEGINS =
  "before-the-review-begins-how-smart-teams-win-with-early-data-insights";

export const DETAIL_SLUG_ATLANTA_MASTERS_MOMENTUM =
  "join-us-in-atlanta-for-the-masters-conference-where-legal-innovation-meets-southern-momentum";

export const DETAIL_SLUG_EVERLAW_SUMMIT_25 =
  "see-whats-next-for-genai-and-the-law-at-everlaw-summit-25";

export const DETAIL_SLUG_MASTERS_SEATTLE =
  "big-ideas-bold-conversations-real-world-lessons-await-at-the-masters-conference-seattle";

/** Sixteenth through twenty-first — full articles */
export const DETAIL_SLUG_MASTERS_PHILLY =
  "brotherly-love-breakthrough-insights-masters-conference-comes-to-philly";

export const DETAIL_SLUG_EARLY_CASE_INTELLIGENCE =
  "early-case-intelligence-why-good-enough-eca-isnt-good-enough-anymore";

export const DETAIL_SLUG_TEXAS_SHOWDOWN =
  "join-us-at-the-texas-legal-showdown-dallas-game-night-sept-10th";

export const DETAIL_SLUG_MOBILE_BEAST =
  "taming-the-mobile-beast-ediscovery-in-the-age-of-data-overload";

export const DETAIL_SLUG_LEGAL_OPS_TRAILBLAZERS =
  "turning-pressure-into-progress-lessons-from-legal-ops-trailblazers";

export const DETAIL_SLUG_OFFSHORE_UPGRADE =
  "not-your-old-school-outsourcing-offshore-legal-gets-an-upgrade";

/** Twenty-second through thirtieth — full articles */
export const DETAIL_SLUG_GENAI_HYPE_HANDS = "genai-from-hype-to-hands-on";

export const DETAIL_SLUG_SOCIAL_MEDIA_DISCOVERY =
  "unlocking-social-media-data-next-level-discovery-investigations-support";

export const DETAIL_SLUG_TAR_TRILOGY =
...
export const insightArticles = rawArticles.map((item, index) => {
  const slug =
    index === 0 ? DETAIL_SLUG_ESI_GENAI : slugify(item.title);
  return {
    ...item,
    slug,
    hasArticlePage: SLUGS_WITH_FULL_ARTICLE.has(slug),
  };
});

export function getInsightBySlug(slug) {
  return insightArticles.find((a) => a.slug === slug) ?? null;
}
